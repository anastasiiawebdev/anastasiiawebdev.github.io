...
!function(a) {
	'function' == typeof define && define.amd
			? define(['jquery'], a)
			: a('object' == typeof exports ? require('jquery') : window.jQuery ||
			window.Zepto);
}(function(a) {
	var b, c, d, e, f, g, h = 'Close', i = 'BeforeClose', j = 'AfterClose',
			k = 'BeforeAppend', l = 'MarkupParse', m = 'Open', n = 'Change',
			o = 'mfp', p = '.' + o, q = 'mfp-ready', r = 'mfp-removing',
			s = 'mfp-prevent-close', t = function() {}, u = !!window.jQuery,
			v = a(window), w = function(a, c) {b.ev.on(o + a + p, c);},
			x = function(b, c, d, e) {
				...
				return c === g && b.currTemplate.closeBtn || (b.currTemplate.closeBtn = a(
						b.st.closeMarkup.replace('%title%',
	...
	t.prototype = {
		...
		init: function() {
			...
			b.isLowIE = b.isIE8 = document.all &&
					...
					c), b.supportsTransition = B(), b.probablyMobile = b.isAndroid ||
					b.isIOS ||
		...
		open: function(c) {
			...
			if (c.isObj === !1) {
				...
				var g, h = c.items;
				for (e = 0; e < h.length; e++) if (g = h[e], g.parsed &&
				(g = g.el[0]), g === c.el[0]) {
					b.index = e;
					break;
				}
			...
			(f += ' mfp-align-top'), b.fixedContentPos ? b.wrap.css({
				...
				overflowY: b.st.overflowY,
					...
					{top: v.scrollTop(), position: 'absolute'}), (b.st.fixedBgPos ===
					!1 || 'auto' === b.st.fixedBgPos && !b.fixedContentPos) &&
			b.bgOverlay.css(
					{height: d.height(), position: 'absolute'}), b.st.enableEscapeKey &&
			d.on('keyup' + p, function(a) {27 === a.keyCode && b.close();}), v.on(
					'resize' + p,
					function() {b.updateSize();}), b.st.closeOnContentClick ||
			(f += ' mfp-auto-cursor'), f && b.wrap.addClass(f);
			...
			b._addClassToMFP(r), b.updateItemHTML(), y('BuildControls'), a('html').
					css(n), b.bgOverlay.add(b.wrap).
					prependTo(b.st.prependTo ||
							a(document.body)), b._lastFocusedEl = document.activeElement, setTimeout(
					function() {
						b.content
		...
		close: function() {
			b.isOpen && (y(i), b.isOpen = !1, b.st.removalDelay && !b.isLowIE &&
			b.supportsTransition ? (b._addClassToMFP(r), setTimeout(
					function() {b._close();}, b.st.removalDelay)) : b._close());
		},
		_close: function() {
			y(h);
			var c = r + ' ' + q + ' ';
			if (b.bgOverlay.detach(), b.wrap.detach(), b.container.empty(), b.st.mainClass &&
			(c += b.st.mainClass + ' '), b._removeClassFromMFP(
					c), b.fixedContentPos) {
				var e = {marginRight: ''};
			...
			d.off('keyup' + p + ' focusin' + p), b.ev.off(p), b.wrap.attr('class',
					'mfp-wrap').removeAttr('style'), b.bgOverlay.attr('class',
					'mfp-bg'), b.container.attr('class',
					'mfp-container'), !b.st.showCloseBtn || b.st.closeBtnInside &&
			b.currTemplate[b.currItem.type] !== !0 || b.currTemplate.closeBtn &&
			b.currTemplate.closeBtn.detach(), b.st.autoFocusLast &&
			b._lastFocusedEl && a(b._lastFocusedEl).
		...
		updateItemHTML: function() {
			...
			if (y('BeforeChange', [
				...
				d]), b.currItem = c, !b.currTemplate[d]) {
				var f = b.st[d]
						? b.st[d].markup
						: !1;
			...
			var g = b['get' + d.charAt(0).toUpperCase() + d.slice(1)](c,
					b.currTemplate[d]);
			b.appendContent(g, d), c.preloaded = !0, y(n,
					c), e = c.type, b.container.prepend(b.contentContainer), y(
					'AfterChange');
		},
		appendContent: function(a, c) {
			b.content = a, a ? b.st.showCloseBtn && b.st.closeBtnInside &&
			b.currTemplate[c] === !0 ? b.content.find('.mfp-close').length ||
					b.content.append(z()) : b.content = a : b.content = '', y(
					k), b.container.addClass(
		...
		parseEl: function(c) {
			...
			if (e.tagName ? e = {el: a(e)} : (d = e.type, e = {
				...
				for (var f = b.types, g = 0; g < f.length; g++) if (e.el.hasClass(
						'mfp-' + f[g])) {
					d = f[g];
					break;
				}
			...
			return e.type = d || b.st.type ||
					'inline', e.index = c, e.parsed = !0, b.items[c] = e, y(
		...
		_openClick: function(c, d, e) {
			...
			if (f || !(2 === c.which || c.ctrlKey || c.metaKey || c.altKey ||
					c.shiftKey)) {
		...
		updateStatus: function(a, d) {
			if (b.preloader) {
				c !== a && b.container.removeClass('mfp-s-' + c), d || 'loading' !==
				a || (d = b.st.tLoading);
				var e = {status: a, text: d};
				y('UpdateStatus', e), a = e.status, d = e.text, b.preloader.html(
						d), b.preloader.find('a').
						on('click',
								function(a) {a.stopImmediatePropagation();}), b.container.addClass(
						'mfp-s-' + a), c = a;
			}
		},
		_checkIfClose: function(c) {
			if (!a(c).
				...
				if (d && e) return !0;
				if (!b.content || a(c).hasClass('mfp-close') || b.preloader && c ===
						b.preloader[0]) return !0;
				if (c === b.content[0] ||
						a.contains(b.content[0], c)) {if (d) return !0;} else if (e &&
						a.contains(document, c)) return !0;
				return !1;
			}
		},
		...
		_getScrollbarSize: function() {
			if (void 0 === b.scrollbarSize) {
				...
				a.style.cssText = 'width: 99px; height: 99px; overflow: scroll; position: absolute; top: -9999px;', document.body.appendChild(
						a), b.scrollbarSize = a.offsetWidth -
		...
		registerModule: function(b, c) {
			c.options && (a.magnificPopup.defaults[b] = c.options), a.extend(
					this.proto, c.proto), this.modules.push(b);
		},
		defaults: {
			disableOn: 0,
			key: null,
		...
		if ('string' == typeof c) if ('open' === c) {
			...
			f.items ? e = f.items[g] : (e = d, f.delegate &&
			(e = e.find(f.delegate)), e = e.eq(g)), b._openClick({mfpEl: e}, d, f);
		} else b.isOpen &&
		b[c].apply(b, Array.prototype.slice.call(arguments, 1)); else c = a.extend(
				!0, {}, c), u
			...
			getInline: function(c, d) {
				if (G(), c.src) {
					...
					if (f.length) {
						...
						g && g.tagName &&
						(D || (C = e.hiddenClass, D = x(C), C = 'mfp-' + C), E = f.after(D).
								detach().
				...
				var d = a.extend({
					...
					success: function(d, e, f) {
						...
						y('ParseAjax', g), b.appendContent(a(g.data),
								I), c.finished = !0, J(), b._setFocus(), setTimeout(
								function() {b.wrap.addClass(q);}, 16), b.updateStatus(
		...
		options: {
			...
			initImage: function() {
				...
				b.types.push('image'), w(m + d, function() {
					...
					c.cursor && a(document.body).removeClass(c.cursor), v.off(
							'resize' + p);
			...
			_onImageHasSize: function(a) {
				a.img &&
				(a.hasSize = !0, L && clearInterval(L), a.isCheckingImgSize = !1, y(
			...
			getImage: function(c, d) {
				var e = 0, f = function() {
					c && (c.img[0].complete
							...
							(b._onImageHasSize(c), b.updateStatus(
									'ready')), c.hasSize = !0, c.loaded = !0, y(
									'ImageLoadComplete'))
					...
					(b._onImageHasSize(c), b.updateStatus('error',
							h.tError.replace('%url%',
									c.src))), c.hasSize = !0, c.loaded = !0, c.loadError = !0);
				...
				return b._parseMarkup(d, {title: M(c), img_replaceWith: c.img},
						...
						(c.imgHidden = !0, d.addClass('mfp-loading'), b.findImageSize(
								c)), d);
			},
		},
	});
	...
	a.magnificPopup.registerModule('zoom', {
		options: {
					...
					w('BuildControls' + d, function() {
						...
						if (b._allowZoom()) {
							...
							f.css(b._getOffset(!0)), b.wrap.append(f), b.content.css(
									'visibility', 'hidden'), setTimeout(
									function() {f.css(b._getOffset());}, 16);
						}
					}), w(h + d,
							function() {b._allowZoom() && (k(), f && f.remove(), a = null);});
				}
			},
			...
			_getOffset: function(c) {
				...
				return O() ? h['-moz-transform'] = h.transform = 'translate(' + e.left +
						'px,' + e.top + 'px)' : (h.left = e.left, h.top = e.top), h;
			},
		},
	});
		...
		proto: {
			initIframe: function() {
				...
				a.each(f.patterns, function() {
					return e.indexOf(this.index) > -1 ? (this.id &&
					(e = 'string' == typeof this.id ? e.substr(
							e.lastIndexOf(this.id) + this.id.length, e.length) : this.id.call(
							this, e)), e = this.src.replace('%id%', e), !1) : void 0;
				});
				var g = {};
				return f.srcAction && (g[f.srcAction] = e), b._parseMarkup(d, g,
						c), b.updateStatus('ready'), d;
			},
		},
	});
	var S = function(a) {
	...
	a.magnificPopup.registerModule('gallery', {
		...
		proto: {
			initGallery: function() {
				...
				return b.direction = !0, c && c.enabled ? (f += ' mfp-gallery', w(m + e,
						function() {
					...
					if (b.items.length > 1 && c.arrows && !b.arrowLeft) {
						var d = c.arrowMarkup, e = b.arrowLeft = a(
								...
								addClass(s);
						e.click(function() {b.prev();}), f.click(
								function() {b.next();}), b.container.append(e.add(f));
					}
				}), w(n + e, function() {
					b._preloadTimeout &&
					clearTimeout(b._preloadTimeout), b._preloadTimeout = setTimeout(
			...
			_preloadItem: function(c) {
				if (c = S(c), !b.items[c].preloaded) {
					...
					d.type && (d.img = a('<img class="mfp-img" />').
    ...
    init: function () {
      ...
      gallery2: function() {
				...
				$('.open-gallery-link').click(function() {
					...
					// $( $(this).attr('href') ).find('.js-gallery-slide').each(function() {
					// 	items.push( {
					// 		src: $(this)
					// 	} );
					// });
